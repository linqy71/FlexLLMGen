...
class LSH{
    public: 
        ...
        void clear();
        void batch_retrieve_multi(int layer_id, torch::Tensor query_pt, int num_queries, torch::Tensor results_pt, torch::Tensor nnz_pt, torch::Tensor hit_counts_pt, int max_index);
    ...
    private:
        ...
        int retrieve_multi(int layer_id, int head_id, int* __restrict query, int num_queries, int* __restrict results, int *__restrict hit_counts, int max_index);
};