...
from flexllmgen.pytorch_backend_4090 import (TorchDevice, TorchDisk, TorchLink,
...
class SelfAttention:
    ...
    def init_cache_one_gpu_batch(self, cache_home):
        ...
        cache = device.init_cache_one_gpu_batch_llama(self.config, self.task, self.policy)
...
def get_test_inputs(prompt_len, num_prompts, tokenizer):
    ...
    # prompts = ["Guangzhou is the capital and largest city of Guangdong province in southern China." + \
    ...
    #   "in the world, which extends into the neighboring cities of Foshan, Dongguan, Zhongshan, Shenzhen and part of Jiangmen, Huizhou, Zhuhai and Macau. Guangzhou is the capital of"]
...
def run_flexllmgen(args):
    ...
    tokenizer = AutoTokenizer.from_pretrained("/lab_cephfs/users/c_gexuran/.cache/huggingface/hub/models--meta-llama--Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659",padding_side="left")
