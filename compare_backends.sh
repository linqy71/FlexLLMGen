...
# echo ""
# echo "🔍 结果对比分析"
# if [ -f "hf_results.jsonl" ] && [ -f "flexgen_results.jsonl" ]; then
#     echo "📋 文件大小对比:"
#     echo "   HuggingFace: $(wc -c < hf_results.jsonl) 字节"
#     echo "   FlexGen:     $(wc -c < flexgen_results.jsonl) 字节"
    
#     echo ""
#     echo "📝 第一个结果对比:"
#     echo "HuggingFace 第一行："
#     head -1 hf_results.jsonl | python3 -c "
# import json, sys
