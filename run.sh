...
nsys launch python3 -m flexllmgen.LSH_opt_dapr --model facebook/opt-30b \
        ...
        --overlap=True \
        --save-res=False \
        --offload-dir /ssd/nsccgz_zgchen_6/lqy/flexllmgen_offload_dir/gathering  > log/6.7b_layer_seq_f_8192_dapr_saveLSH.log 2>&1
